...
if [ -z $1 ]; then
    ...
    # BUILDS="n18z,2 r7000z,3 r6400z,5 ws880z,11 wzr1750z,12 ea6700z,13"
    # BUILDS="r64z,1 r6400z,5 ws880z,11 wzr1750z,12 ea6700z,13"
else
    BUILDS=$1,1
fi
